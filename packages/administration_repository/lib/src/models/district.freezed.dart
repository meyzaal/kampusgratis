...
abstract class $DistrictCopyWith<$Res> {
  ...
  @useResult
  $Res call({String code, String regencyCode, String name});
}
...
class _$DistrictImpl implements _District {
  const _$DistrictImpl(
      {required this.code, required this.regencyCode, required this.name});
...
abstract class _District implements District {
  const factory _District(
      ...
      required final String regencyCode,
      required final String name}) = _$DistrictImpl;

...
abstract class _Biodatas implements Biodatas {
  const factory _Biodatas(
      ...
      final String? university,
      final String? major,
      final int? semester}) = _$BiodatasImpl;
